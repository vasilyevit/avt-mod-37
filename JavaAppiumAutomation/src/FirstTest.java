...
public class FirstTest {
    ...
    public void testCancelSearchEx3(){
        ...
        assertTrue(
                ...
                getElementList(By.xpath("//*[@resource-id='org.wikipedia:id/page_list_item_container']")).size() > 1);
    ...
    public void testAmountOfNotEmptySearch(){
        ...
        String search_line = "zxcasdfdgcvb";
        waitForElementAndSendKeys(
                By.xpath("//*[contains(@text,'Search…')]"),
                search_line,
                "Cannot find search input",
        ...
        String search_result_locator = "//*[@resource-id='org.wikipedia:id/page_results_list']//*[@resource-id='org.wikipedia:id/page_list_item_container']";
    ...
    public void testEx5(){
        ...
        waitForElementAndClick(
                ...
                15);
        String title = waitForElementAndGetText(
                By.xpath("//*[@resource-id='org.wikipedia:id/view_page_title_text']"),
                "Cannot find tile of article",
                15
        );
    ...
    private void assertElementNotPresent(By by, String error_message) {
        ...
        if (amount_of_elements > 0) {
            String default_message = "An element '" + by.toString() + "' supposed to bu not present";
